    ...
    <div className="app">
      <Tabs defaultValue={0} value={activeTab}>
        <Tabs.TabList onTabChange={onSelectedTab} className="tab-list">
          <Tabs.Tab id="tab-eye" className="tab-item">
            <i className="fa fa-eye"></i> {/* Icon from font-awesome V6 */}
            <span className="label">Eye</span>
          </Tabs.Tab>
          <Tabs.Tab id="tab-comments" className="tab-item">
            <i className="fa fa-comments"></i>
            <span className="label">Comments</span>
          </Tabs.Tab>
          <Tabs.Tab id="tab-bell" className="tab-item">
            <i className="fa fa-bell"></i>
            <span className="label">Bell</span>
          </Tabs.Tab>
          <Tabs.Tab id="tab-cog" className="tab-item">
            <i className="fa fa-cog"></i>
            <span className="label">Cog</span>
          </Tabs.Tab>
        </Tabs.TabList>

        <Tabs.TabPanel id="tab-eye">
          <h3>Dashboard</h3>
          <p>Welcome to the Dashboard</p>
        </Tabs.TabPanel>

        <Tabs.TabPanel id="tab-comments">
          <h3>Comments</h3>
          <p>Welcome to the Comments section</p>
        </Tabs.TabPanel>

        <Tabs.TabPanel id="tab-bell">
          <h3>Notifications</h3>
          <p>No Notfications available</p>
        </Tabs.TabPanel>

        <Tabs.TabPanel id="tab-cog">
          <h3>Settings</h3>
